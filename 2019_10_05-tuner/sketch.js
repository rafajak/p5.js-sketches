...
function draw() {
	if (display_text == true) {
		...
		if (image_cache.length < 10) {
			...
			text("The strange images you'll see will be generated by your computer.", width / 2 - 210, height / 2 + 20 * 4)
			...
			text("The results are bad, and so is the accompanying music I made.", width / 2 - 210, height / 2 + 20 * 7)
			text("(I hope you like it)", width / 2 - 210, height / 2 + 20 * 9)
			textSize(12);
